...
- month_dest.csv - greenhouse gas and biodiverity impacts grouped by destination by month
- graphs - a folder containing graphs that correspond with month, dest and month_dest
